...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('soal-update', $soal->id) }}" method="POST" id="formAddModal">
                    @csrf
                        <div id="shimmer">
                            <div class="cols2">
                                <div class="col2">
                        ...
                        <div class="form-group" id="section_soal">
                            <label for="">Soal No : {{ $urutan }}</label>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex flex-wrap">
                                                <div class="form-group mr-2" style="width: 500px">
                                                    <input type="text" required name="nilai[]"
                                                        value="{{ $jawaban[0]->nilai_jawaban }}" id="sectionTitle"
                                                        class="form-control">
                                                    <input type="hidden" value="1" id="no_jawaban" name="no_jawaban[]"
                                                        value="{{ $jawaban[0]->no_jawaban }}">
                                                </div>
                                            ...
                                            <div class="">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="jawaban[]" required class="jawaban" id="jawaban">{!! $jawaban[0]->jawaban !!}</textarea>
                                                    @error('jawaban')
                                                        <div class="alert alert-danger mt-2 " role="alert" id="alert-soal">
                                                            {{ $message }}
                                                        </div>
                                            ...
                                            <div class="" id="fieldGroupTemplate">
                                                <div class="d-flex flex-wrap">
                                                    <div class="form-group floating-label mr-2" style="width: 500px">
                                                        <input type="text" name="nilai[]"
                                                            value="{{ $hasil_2['nilaiJawaban'] }}" id="sectionTitle"
                                                            class="form-control">
                                                        <input type="hidden" id="no_jawaban2" name="no_jawaban[]"
                                                            value="{{ $hasil_2['noJawaban'] }}">
                                                    </div>
                                                ...
                                                <div class="">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="jawaban[]" class="jawaban2">{!! $hasil_2['jawaban'] !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="" id="fieldGroupTemplate">
                                                <div class="d-flex flex-wrap">
                                                    <div class="form-group floating-label mr-2" style="width: 500px">
                                                        <input type="text" name="nilai[]"
                                                            value="{{ $hasil_3['nilaiJawaban'] }}" id="sectionTitle"
                                                            class="form-control">
                                                        <input type="hidden" id="no_jawaban3" name="no_jawaban[]"
                                                            value="{{ $hasil_3['noJawaban'] }}">
                                                    </div>
                                                ...
                                                <div class="">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="jawaban[]" class="jawaban3">{!! $hasil_3['jawaban'] !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="" id="fieldGroupTemplate">
                                                ...
                                                <div class="d-flex flex-wrap">
                                                    <div class="form-group floating-label mr-2" style="width: 500px">
                                                        <input type="text" name="nilai[]"
                                                            value="{{ $hasil_4['nilaiJawaban'] }}" id="sectionTitle"
                                                            class="form-control">
                                                        <input type="hidden" id="no_jawaban4" name="no_jawaban[]"
                                                            value="{{ $hasil_4['noJawaban'] }}">
                                                    </div>
                                                    <div class="d-flex flex-wrap" style="height: 38px">
                                                ...
                                                <div class="">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="jawaban[]" class="jawaban4">{!! $hasil_4['jawaban'] !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="" id="fieldGroupTemplate">
                                                ...
                                                <div class="d-flex flex-wrap">
                                                    <div class="form-group floating-label mr-2" style="width: 500px">
                                                        <input type="text" name="nilai[]"
                                                            value="{{ $hasil_5['nilaiJawaban'] }}" id="sectionTitle"
                                                            class="form-control">
                                                        <input type="hidden" id="no_jawaban5" name="no_jawaban[]"
                                                            value="{{ $hasil_5['noJawaban'] }}">
                                                    </div>
                                                    <div class="d-flex flex-wrap" style="height: 38px">
                                                ...
                                                <div class="">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="jawaban[]" class="jawaban5">{!! $hasil_5['jawaban'] !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            CKEDITOR.ClassicEditor.create(document.querySelector(".soal"), {
                ...
                ckfinder: {
                    uploadUrl: '{{ route('ckeditor.upload') }}?id_bank_soal={{ $soal->id_bank_soal }}&_token={{ csrf_token() }}',
                },
                removePlugins: [
