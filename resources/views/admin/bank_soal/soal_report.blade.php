...
<body>
    <a href="{{ url('bank_soal/soal/print/'.$id.'/'.$opsi)  }}" class="float" id="menu-share">
    ...
    <div id="section-to-print">
        ...
        @foreach($soal as $raw)
            ...
            <!-- <h5 style="margin-bottom:-10px; margin-right:-10px;">{{ $loop->iteration }}.</h5> -->
            <table>
                <tr>
                    <td style="vertical-align:top; padding-top:17px;">{{ $loop->iteration }}.</td>
                    <td class="soal_spasi">{!! $raw->soal !!}</td>
                </tr>
            </table>
            <?php 
            ...
            <table style="margin-top: -30px;">
                <tr>
                    <td class="abjad">{{ $data->abjad }}.</td>
                    <td class="jawaban">{!! $data->jawaban !!}</td>
                </tr>
            </table>
            @endforeach
            @if($opsi == 'jawaban')
