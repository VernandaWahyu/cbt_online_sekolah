...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <h4>{{ $bank_soal->nama_bank_soal }}</h4>
                    <form action="{{ url('bank_soal/soal/store') }}" method="POST" id="formAddModal">
                        @csrf
                        ...
                        <div class="row fieldGroup">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                <input type="text" required name="nilai[]" value="{{ old('nilai') }}" id="sectionTitle" class="form-control">
                                </div>
                            </div>
                        ...
                        <div class="row" id="fieldGroupTemplate">
                            ...
                            <div class="col-sm-12 ">
                                <div class="form-group">
                                <label for="">Jawaban</label>
                                <textarea name="jawaban[]" class="jawaban"></textarea>
                                </div>
                            </div>
                        </div>
