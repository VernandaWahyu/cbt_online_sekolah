...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
                <a href="/bank_soal/soal/tambah?bank_soal_id={{ $bank_soal->id }}"  class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" >
                <i class="fas fa-plus fa-sm text-white-50"></i> Tambah Soal</a>
                
                <!-- <a href="{{ url('bank_soal/soal/report', $bank_soal->id)  }}"  class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm" >
                ...
                <a href="{{ url('bank_soal/soal/backup', $bank_soal->id)  }}"  class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm" >
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Daftar Soal {{ $bank_soal->nama_bank_soal }}</h6>
                </div>
                <div class="card-body">
    ...
    <div class="modal-dialog" role="document">
        ...
        <form action="{{ url('bank_soal/soal/import', $bank_soal->id)  }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="file" class="col-form-label">File Word Soal</label>
                <input type="file" name="file" class="form-control">
                <p></p>
                <a href="{{url('Contoh Soal.docx')}}">Contoh Template Word Soal</a>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
        <form action="{{ url('bank_soal/soal/report', $bank_soal->id)  }}" method="POST" enctype="multipart/form-data">
            @csrf
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
        <form action="{{ url('bank_soal/soal/upload', $bank_soal->id)  }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="file" class="col-form-label">File Upload</label>
                <input type="file" name="file" class="form-control">
                <input type="hidden" name="id_bank_soal" value="{{ $bank_soal->id }}">
            </div>
        </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            // Data Tables 
            var bank_soal_id = "{{ $bank_soal->id }}"
            var table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                          url:"{!! url('/bank_soal/detail') !!}",
                          data: function (i) {
        ...
        function hapus(id){
                ...
                confirmButtonText: 'Ya, Hapus sekarang!'
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ url('bank_soal/soal/delete')}}"+"/"+id,
                            type: "DELETE",
                            data:{
                                "_token" : "{{ csrf_token() }}",
                            },
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="hidden" value=" {{ $bank_soal->id }}" name="bank_soal_id">
