...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <h4 style="color:black;">{{ $bank_soal->nama_bank_soal }}</h4>
                    <form action="{{ url('bank_soal/soal/store') }}" method="POST" id="formAddModal" novalidate>
                        @csrf
                        <div id="shimmer">
                            <div class="cols2">
                                <div class="col2">
                        ...
                        <div class="form-group" id="section_soal">
                            ...
                            <input type="hidden" name="bank_soal_id" value="{{ $bank_soal->id }}" id="">
                            @error('soal')
                                                ...
                                                <div class="d-flex flex-wrap">
                                                    <div class="form-group floating-label mr-2" style="width: 500px">
                                                        ...
                                                        <input type="hidden" value="" id="no_jawaban2"
                                                            name="no_jawaban[]" value="{{ old('no_jawaban') }}">
                                                    </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="" id="fieldGroupTemplate">
                                                ...
                                                <div class="d-flex flex-wrap">
                                                    ...
                                                    <div class="d-flex flex-wrap" style="height: 38px">
                                                        {{-- <a href="javascript:void(0)" class="btn btn-success addMore mr-2"
                                                            id="add5">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            CKEDITOR.ClassicEditor.create(document.querySelector(".soal"), {
                ...
                ckfinder: {
                    uploadUrl: '{{ route('ckeditor.upload') }}?id_bank_soal={{ $bank_soal->id }}&_token={{ csrf_token() }}',
                },
                removePlugins: [
