...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            var nama_pembuat = {!! json_encode(Auth::user()->name) !!};
        ...
        function detail(id){
            window.location.href="{{url('ujian/detail')}}"+"/"+id;
        }

        function list_siswa(id){
            window.location.href="{{url('ujian/list_siswa')}}"+"/"+id;
        }
    </script>
@stop
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <label for="">Jadwal Mulai</label>
                <input class="form-control" type="text" value="{{ date('d-m-Y') }}" id="jadwal_mulai_add" required>
            </div>
            ...
            <div class="form-group">
                <label for="">Jadwal Selesai</label>
                <input class="form-control" type="text" value="{{ date('d-m-Y') }}" id="jadwal_selesai_add" required>
            </div>
