                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body d-flex">
                            ...
                            &nbsp;&nbsp;
                            <div class="bio">
                                <h5 style="margin-top: 10px;">{{ $profile->name }}</h5>
                                <p style="margin-top: -10px;">{{ $profile->no_siswa }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input disabled type="text" class="form-control" id="nama" value="{{ $profile->name }}">
                                </div>

                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">No. Siswa</label>
                                    <input disabled type="text" class="form-control" id="nama" value="{{ $profile->no_siswa }}">
                                </div>

                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Kelas</label>
                                    <input disabled type="text" class="form-control" id="nama" value="{{ $profile->nama_kelas }}">
                                </div>

                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Program</label>
                                    <input disabled type="text" class="form-control" id="nama" value="{{ $profile->nama_program }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="email" onclick="return false;" type="email" class="form-control" id="nama" value="{{ $profile->email }}">
                                </div>
