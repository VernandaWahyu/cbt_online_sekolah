                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td style="text-align: right;">
                                            <span class="badge rounded-pill bg-primary">{{ $ujian->nama_ujian }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Waktu Ujian</td>
                                        <td style="text-align: right;">
                                            <span class="badge rounded-pill bg-success">{{ $ujian->durasi_max }} Menit</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Jumlah</td>
                                        <td style="text-align: right;">
                                            <span class="badge rounded-pill bg-danger">{{ $sum_soal }} Soal</span>
                                        </td>
                                    </tr>
                                </table>
                                <p></p>
                                <center>
                                    <a href="{{ url('/soal', $ujian->id_ujian_siswa) }}" class="btn btn-warning w-50 mt-2">Mulai Ujian</a>
                                </center>
                            </div>
                        </div>
                    </a>
