...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" id="printableArea">
            ...
            <div class="kartu" id="kartu<?php echo e($index); ?>"> <!-- Tambahkan ID dengan nomor indeks -->
                <h2 class="title" style="color:grey;">CBT Online</h2>
                <div class="content">
                    <div class="picture">
                        <?php if($data->avatar && file_exists(public_path('storage/images/'.$data->avatar))): ?>
                            <img src="<?php echo e(asset('/storage/images/'.$data->avatar)); ?>" width="100" />
                        <?php else: ?>
                            <img src="<?php echo e(url('sbadmin/img/avatar.png')); ?>" width="100" />
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="bio">
                        <table>
                            ...
                            <tr>
                                <td>No. Siswa</td>
                                <td>:</td>
                                <td><?php echo e($data->no_siswa); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\cbt_online_sekolah\resources\views/admin/siswa/cetak.blade.php ENDPATH**/ ?>