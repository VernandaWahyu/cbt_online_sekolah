...
<?php $__env->startSection('list-guru','active'); ?>
<?php $__env->startSection('list-guru','active'); ?>
    ...
    <script>
        $(function () {
            ...
            $('#formEditModal').on('submit', function(e){
                ...
                $.ajax({
                    url: "<?php echo e(url('guru/update')); ?>",
                    type: "POST",
                    data: {
        ...
        function hapus(id){
                ...
                confirmButtonText: 'Ya, Hapus sekarang!'
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo e(url('guru/delete')); ?>"+"/"+id,
                            type: "DELETE",
                            data:{
                                "_token" : "<?php echo e(csrf_token()); ?>",
                            },
        ...
        function edit(id){
            ...
            $.ajax({
                url: "<?php echo e(url('guru/edit')); ?>/"+id,
                type: "GET",
                dataType: "json",
                success: function(response){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cbt_online_sekolah\resources\views/admin/guru/index.blade.php ENDPATH**/ ?>