...
<?php $__env->startSection('list-program-bimbel','active'); ?>
<?php $__env->startSection('list-program-bimbel','active'); ?>
    ...
    <script>
        $(function () {
            ...
            $('#formEditModal').on('submit', function(e){
                ...
                $.ajax({
                    url: "<?php echo e(url('program_bimbel/update')); ?>",
                    type: "POST",
                    data: formData,
        ...
        $('#formAddModal').on('submit', function(e){
            ...
            $.ajax({
                url: "<?php echo e(url('program_bimbel/store')); ?>",
                type: "POST",
                data: formData,
                processData: false, // Diperlukan saat mengirim FormData
                contentType: false, // Diperlukan saat mengirim FormData
        ...
        function hapus(id){
                ...
                confirmButtonText: 'Ya, Hapus sekarang!'
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo e(url('program_bimbel/delete')); ?>"+"/"+id,
                            type: "DELETE",
                            data:{
        ...
        function edit(id){
            ...
            $.ajax({
                url: "<?php echo e(url('program_bimbel/edit')); ?>/"+id,
                type: "GET",
                dataType: "json",
                success: function(response){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cbt_online_sekolah\resources\views/admin/program_bimbel/index.blade.php ENDPATH**/ ?>