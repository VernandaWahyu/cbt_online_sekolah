...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-3 col-lg-8">
            ...
            <div class="row">
                <center>
                    <h3>Ujian Telah Selesai</h3>
                    <div id="animationContainer" style="width: 220px; height: 220px;"></div>
                    <a href="<?php echo e(url('home')); ?>" class="btn btn-primary w-50 mt-2">Kembali Home</a>
                </center>
            </div>
...
<?php /**PATH C:\xampp\htdocs\cbt_online_sekolah\resources\views/siswa/selesai.blade.php ENDPATH**/ ?>