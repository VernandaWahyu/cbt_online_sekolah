        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Tambah Siswa -> <?php echo e($kelas->nama_kelas); ?></h6>
                </div>

                <form role="form" method="POST" action="<?php echo e(url('/kelas/simpan/list_siswa')); ?>">
				        <?php echo e(csrf_field()); ?>

                <div class="card-body">

                  <input type="hidden" name="id_kelas" id="id_kelas" value="<?php echo e($id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cbt_online_sekolah\resources\views/admin/kelas/tambah_siswa.blade.php ENDPATH**/ ?>